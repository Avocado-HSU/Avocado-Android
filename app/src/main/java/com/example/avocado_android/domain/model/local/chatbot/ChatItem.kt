...
sealed class ChatItem {
    ...
    data class ChatTipsListItem(val cards: List<ChatTipItem>) : ChatItem()
    data class ChatTipItem(val imageUri: Int, val title: String, val description: String) : ChatItem()
}