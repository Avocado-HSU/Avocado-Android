...
interface ChatBotRepository {
    ...
    suspend fun getWordMean(requestType: String, word: String): Flow<WordMeanDto>
    suspend fun getWordEtymology(requestType: String, word: String): Flow<WordEtymologyDto>
}