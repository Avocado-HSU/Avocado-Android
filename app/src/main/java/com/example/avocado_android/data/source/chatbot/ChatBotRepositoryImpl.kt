...
class ChatBotRepositoryImpl @Inject constructor(
    ...
    override suspend fun getWordMean(requestType: String, word: String): Flow<WordMeanDto>  = dataSource.getWordMean(requestType, word)
    override suspend fun getWordEtymology(requestType: String, word: String): Flow<WordEtymologyDto>  = dataSource.getWordEtymology(requestType, word)
}